...
const inID = mergeLocale(base, {
  ...
  Cascader: { placeholder: 'Silahkan Pilih' },
  Dialog: { ok: 'Saya mendapatkannya' },
  DatePicker: { tillNow: 'Sampai sekarang' },
  ErrorBlock: {
    default: {
  ...
  ImageUploader: { uploading: 'mengunggah...', upload: 'diunggah' },
  InfiniteScroll: {
  ...
  SearchBar: { name: 'Bilah Pencarian' },
  Slider: { name: 'Penggeser' },
