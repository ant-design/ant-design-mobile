...
import {
  ApplyPluginsType,
  dynamic,
} from '/Users/jilin/projects/antd/antd-mobile/node_modules/.pnpm/@umijs+runtime@3.5.41_react@16.14.0/node_modules/@umijs/runtime'
        ...
        dynamic({
          loader: async () => {
            ...
            const { default: getDemoRenderArgs } = await import(
              /* webpackChunkName: 'dumi_demos' */ '/Users/jilin/projects/antd/antd-mobile/node_modules/.pnpm/@umijs+preset-dumi@1.1.53_react-dom@18.2.0_react@18.2.0_typescript@4.6.4_umi@3.5.41/node_modules/@umijs/preset-dumi/lib/plugins/features/demo/getDemoRenderArgs'
            )
