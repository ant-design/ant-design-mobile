...
export default () => {
  ...
  return (
    <Tabs autoScroll={false}>
      <Tabs.Tab key='1' title={num}></Tabs.Tab>
      <Tabs.Tab key='2' title='文字'></Tabs.Tab>
      <Tabs.Tab key='3' title='文字'></Tabs.Tab>
      <Tabs.Tab key='4' title='文字'></Tabs.Tab>
      <Tabs.Tab key='5' title='文字'></Tabs.Tab>
      <Tabs.Tab key='6' title='文字'></Tabs.Tab>
      <Tabs.Tab key='7' title='文字'></Tabs.Tab>
      <Tabs.Tab key='8' title='文字'></Tabs.Tab>
    </Tabs>
  )
}
