...
| --gap            | The gap between items. (Valid only in columns mode)                 | `12px`       |
| --gap-horizontal | The horizontal gap between items.(Valid only in columns mode)       | `var(--gap)` |
| --gap-vertical   | The vertical gap between items.(Valid only in columns mode)         | `var(--gap)` |
