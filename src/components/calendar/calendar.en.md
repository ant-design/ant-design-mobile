...
| nextWeekButton    | Contents of the Next Week button on the navigation pane                         | `React.ReactNode`                                                                                                                    | `>`        |
...
| prevWeekButton    | Contents of the Last Week button on the navigation pane                         | `React.ReactNode`                                                                                                                    | `<`        |
...
| weekModel         | Use a Week full                                                                 | `boolean`                                                                                                                            | `false`    |
