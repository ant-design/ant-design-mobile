  ...
  render() {
    ...
    >
      ...
      <div className={lineCls}>
        {children !== null && children !== undefined ? <div className={`${prefixCls}-content`}>{children}</div> : null}
        {extra !== null && extra !== undefined ? <div className={`${prefixCls}-extra`}>{extra}</div> : null}
