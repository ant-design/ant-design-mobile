...
ReactDOM.render(
  ...
  <ListWrap >
    <ListBody>
      ...
      />
      <ListItem
        content={<div><div className="am-list-title">title</div><div className="am-list-brief">brief</div></div>}
      ...
      <ListItem
        ...
        line={2}
        extra={<button type="button" className="am-button am-button-tiny am-button-light am-button-inline">按钮</button>}
      />
      <ListItem
      ...
      <ListItem
        content="dada"
        extra={<div><div className="am-list-title">客服经理</div><div className="am-list-brief">自定义权限</div></div>}
        line={2}
        arrow="horizontal"
      />
    </ListBody>
